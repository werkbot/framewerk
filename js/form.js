window.addEventListener('load', function(){
  ...
  document.querySelectorAll('.fw-form input[type=text], .fw-form input[type=date], .fw-form input[type=time], .fw-form input[type=email], .fw-form input[type=password], .fw-form textarea').forEach(function(inputElement){
  ...
  function toggleInputState(inputElement){
    if(inputElement.value || inputElement.placeholder || inputElement === document.activeElement || inputElement.type == 'date' || inputElement.type == 'time' || inputElement.type == 'email' || inputElement.type == 'password'){
